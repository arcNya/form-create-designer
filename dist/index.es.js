...
import { defineComponent as Pn, openBlock as et, createElementBlock as Gt, createElementVNode as gt, markRaw as Zf, computed as io, unref as qf, isRef as Rv, ref as Zi, resolveComponent as ht, TransitionGroup as Pv, h as ta, nextTick as Nr, toRefs as Ul, getCurrentInstance as Iv, reactive as rl, provide as Sf, toRef as Qi, watch as il, createBlock as Hn, normalizeStyle as Lv, withCtx as nt, createVNode as _e, Fragment as _f, renderList as ed, toDisplayString as cn, normalizeClass as Xo, createCommentVNode as vn, withDirectives as jo, vShow as $o, createTextVNode as Or, inject as Nv, withModifiers as Ov, renderSlot as Fv, pushScopeId as Bv, popScopeId as Hv, mergeProps as Uv } from "vue";
...
function Yv(c, A, l, o, t, s) {
  return et(), Gt("svg", Wv, $v);
}
const Vv = /* @__PURE__ */ gr(zv, [["render", Yv]]);
function Gi({ t: c }) {
  return [
    {
      type: "input",
...
let Gv = 0;
function St() {
  return "F" + Math.random().toString(36).substr(3, 3) + Number(`${Date.now()}${++Gv}`).toString(36);
}
function kv(c, A, l) {
...
const Cf = "[[FORM-CREATE-PREFIX-", Tf = "-FORM-CREATE-SUFFIX]]", wf = "$FN:", Df = "$FNX:", Yo = "function";
function Mf(c) {
...
function Xv(c, A) {
  if (c && xt.String(c) && c.length > 4) {
    ...
    try {
      ...
      if (!o)
        return c;
      const t = Mf(l.indexOf(Yo) === -1 && l.indexOf("(") !== 0 ? Yo + " " + l : l);
      return t.__json = c, t;
    } catch (t) {
      Kv(`\u89E3\u6790\u5931\u8D25:${l}
  ...
  if (c && typeof c == "object") {
    for (let A in c)
      if (Object.prototype.hasOwnProperty.call(c, A)) {
        let l = c[A];
        (Array.isArray(l) || xt.Object(l)) && id(l), xt.String(l) && (c[A] = Xv(l));
      }
  }
  return c;
};
...
const qv = (c) => (A, l) => _v(A, l, qf(c)), _v = (c, A, l) => Zv(l, c, "").replace(
  /\{(\w+)\}/g,
  (o, t) => {
    var s;
  ...
  const A = io(() => qf(c).name), l = io(() => oo(Qv(A.value || ""))), o = Rv(c) ? c : Zi(c);
  return {
    lang: A,
    name: l,
    locale: o,
...
}, Wl = (c) => ep(io(() => c.value || Jv)), qe = (c, A, l) => l.map((o) => (o.field === "formCreate$required" ? o.title = c("props.required") || o.title : o.field && o.field !== "_optionType" && (o.title = c("components." + A + "." + o.field) || o.title), o)), tp = "\u5355\u9009\u6846", ol = "radio", jl = {
  icon: "icon-radio",
  label: tp,
  name: ol,
  rule({ t: c }) {
  ...
  props(c, { t: A }) {
    return qe(A, Lf + ".props", [{ type: "input", field: "label", title: "\u9009\u9879\u5361\u6807\u9898" }, {
      type: "switch",
      field: "disabled",
      title: "\u662F\u5426\u7981\u7528"
  ...
  props(c, { t: A }) {
    return qe(A, Sl + ".props", [{ type: "input", field: "title", title: "\u6807\u9898" }, {
      type: "select",
      field: "type",
      title: "\u4E3B\u9898",
...
function Xn() {
  return Xn = Object.assign || function(c) {
    for (var A = 1; A < arguments.length; A++) {
      var l = arguments[A];
      for (var o in l)
...
var Jn = Kn(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), ao = Kn(/Edge/i), Hf = Kn(/firefox/i), _i = Kn(/safari/i) && !Kn(/chrome/i) && !Kn(/android/i), od = Kn(/iP(ad|od|hone)/i), Lp = Kn(/chrome/i) && Kn(/android/i), ad = {
  capture: !1,
  passive: !1
};
function ke(c, A, l) {
  c.addEventListener(A, l, !Jn && ad);
}
function Ye(c, A, l) {
  c.removeEventListener(A, l, !Jn && ad);
}
function na(c, A) {
  if (!!A) {
...
function It(c, A, l, o, t) {
  if (!(!c.getBoundingClientRect && c !== window)) {
    var s, u, d, f, m, T, S;
    if (c !== window && c.parentNode && c !== zn() ? (s = c.getBoundingClientRect(), u = s.top, d = s.left, f = s.bottom, m = s.right, T = s.height, S = s.width) : (u = 0, d = 0, f = window.innerHeight, m = window.innerWidth, T = window.innerHeight, S = window.innerWidth), (A || l) && c !== window && (t = t || c.parentNode, !Jn))
      do
...
var li = [], Dl = {
  ...
  initializePlugins: function(A, l, o, t) {
    li.forEach(function(d) {
      ...
      if (!(!A.options[f] && !d.initializeByDefault)) {
        ...
        m.sortable = A, m.options = A.options, A[f] = m, Xn(o, m.defaults);
      }
    });
  ...
  getEventProperties: function(A, l) {
    ...
    return li.forEach(function(t) {
      typeof t.eventProperties == "function" && Xn(o, t.eventProperties.call(l[t.pluginName], A));
    }), o;
  },
...
function Wp(c) {
  ...
  if (A = A || l && l[pn], !!A) {
    ...
    window.CustomEvent && !Jn && !ao ? x = new CustomEvent(o, {
      bubbles: !0,
      cancelable: !0
...
var Ae, dt, He, it, Lr, Zo, ct, pr, fi, dn, to, vr, Qo, Wt, ui = !1, ra = !1, ia = [], Pr, Rn, Ml, Rl, jf, $f, Ki, si, no, ro = !1, Go = !1, qo, Qt, Pl = [], fs = !1, oa = [], la = typeof document < "u", ko = od, Yf = ao || Jn ? "cssFloat" : "float", $p = la && !Lp && !od && "draggable" in document.createElement("div"), dd = function() {
  if (!!la) {
    if (Jn)
      return !1;
  ...
  return s && (d.display === "block" || d.display === "flex" || d.display === "table" || d.display === "grid" || m >= t && o[Yf] === "none" || u && o[Yf] === "none" && m + T > t) ? "vertical" : "horizontal";
}, Yp = function(A, l, o) {
...
function Ne(c, A) {
  ...
  this.el = c, this.options = A = Xn({}, A), c[pn] = this;
  var l = {
    group: null,
    sort: !0,
    disabled: !1,
...
Ne.prototype = {
  ...
  _prepareDragStart: function(A, l, o) {
    ...
    if (o && !Ae && o.parentNode === s) {
      var m = It(o);
      if (it = s, Ae = o, dt = Ae.parentNode, Lr = Ae.nextSibling, Zo = o, Qo = u.group, Ne.dragged = Ae, Pr = {
        target: Ae,
        clientX: (l || A).clientX,
        clientY: (l || A).clientY
      }, jf = Pr.clientX - m.left, $f = Pr.clientY - m.top, this._lastX = (l || A).clientX, this._lastY = (l || A).clientY, Ae.style["will-change"] = "all", f = function() {
        if (ln("delayEnded", t, {
          evt: A
        }), Ne.eventCanceled) {
          t._onDrop();
        ...
        t._disableDelayedDragEvents(), !Hf && t.nativeDraggable && (Ae.draggable = !0), t._triggerDragStart(A, l), rn({
          sortable: t,
          name: "choose",
          originalEvent: A
        }), fn(Ae, u.chosenClass, !0);
      }, u.ignore.split(",").forEach(function(T) {
        ld(Ae, T.trim(), Il);
      }), ke(d, "dragover", Ir), ke(d, "mousemove", Ir), ke(d, "touchmove", Ir), ke(d, "mouseup", t._onDrop), ke(d, "touchend", t._onDrop), ke(d, "touchcancel", t._onDrop), Hf && this.nativeDraggable && (this.options.touchStartThreshold = 4, Ae.draggable = !0), ln("delayStart", this, {
        evt: A
      }), u.delay && (!u.delayOnTouchOnly || l) && (!this.nativeDraggable || !(ao || Jn))) {
        if (Ne.eventCanceled) {
          this._onDrop();
          return;
        }
  ...
  _dragStarted: function(A, l) {
    if (ui = !1, it && Ae) {
      ...
      var o = this.options;
      !A && fn(Ae, o.dragClass, !1), fn(Ae, o.ghostClass, !0), Ne.active = this, A && this._appendGhost(), rn({
        sortable: this,
        name: "start",
        originalEvent: l
      });
  ...
  _onTouchMove: function(A) {
    if (Pr) {
      var l = this.options, o = l.fallbackTolerance, t = l.fallbackOffset, s = A.touches ? A.touches[0] : A, u = He && di(He, !0), d = He && u && u.a, f = He && u && u.d, m = ko && Qt && Wf(Qt), T = (s.clientX - Pr.clientX + t.x) / (d || 1) + (m ? m[0] - Pl[0] : 0) / (d || 1), S = (s.clientY - Pr.clientY + t.y) / (f || 1) + (m ? m[1] - Pl[1] : 0) / (f || 1);
      if (!Ne.active && !ui) {
    ...
    if (!He) {
      ...
      if (ko) {
        for (Qt = A; Le(Qt, "position") === "static" && Le(Qt, "transform") === "none" && Qt !== document; )
          Qt = Qt.parentNode;
        Qt !== document.body && Qt !== document.documentElement ? (Qt === document && (Qt = zn()), l.top += Qt.scrollTop, l.left += Qt.scrollLeft) : Qt = zn(), Pl = Wf(Qt);
      }
      He = Ae.cloneNode(!0), fn(He, o.ghostClass, !1), fn(He, o.fallbackClass, !0), fn(He, o.dragClass, !0), Le(He, "transition", ""), Le(He, "transform", ""), Le(He, "box-sizing", "border-box"), Le(He, "margin", 0), Le(He, "top", l.top), Le(He, "left", l.left), Le(He, "width", l.width), Le(He, "height", l.height), Le(He, "opacity", "0.8"), Le(He, "position", ko ? "absolute" : "fixed"), Le(He, "zIndex", "100000"), Le(He, "pointerEvents", "none"), Ne.ghost = He, A.appendChild(He), Le(He, "transform-origin", jf / parseInt(He.style.width) * 100 + "% " + $f / parseInt(He.style.height) * 100 + "%");
    }
  },
  _onDragStart: function(A, l) {
    ...
    ln("setupClone", this), Ne.eventCanceled || (ct = fd(Ae), ct.draggable = !1, ct.style["will-change"] = "", this._hideClone(), fn(ct, this.options.chosenClass, !1), Ne.clone = ct), o.cloneId = _o(function() {
      ln("clone", o), !Ne.eventCanceled && (o.options.removeCloneOnHide || it.insertBefore(ct, Ae), o._hideClone(), rn({
        sortable: o,
        name: "clone"
      }));
    }), !l && fn(Ae, s.dragClass, !0), l ? (ra = !0, o._loopId = setInterval(o._emulateDragOver, 50)) : (Ye(document, "mouseup", o._onDrop), Ye(document, "touchend", o._onDrop), Ye(document, "touchcancel", o._onDrop), t && (t.effectAllowed = "move", s.setData && s.setData.call(o, t, Ae)), ke(document, "drop", o), Le(Ae, "transform", "translateZ(0)")), ui = !0, o._dragStartId = _o(o._dragStarted.bind(o, l, A)), ke(document, "selectstart", o), Ki = !0, _i && Le(document.body, "user-select", "none");
  },
  _onDragOver: function(A) {
    ...
    function y(K) {
      return v("dragOverCompleted", {
        insertion: K
      }), K && (T ? m._hideClone() : m._showClone(g), g !== w && (fn(Ae, Wt ? Wt.options.ghostClass : m.options.ghostClass, !1), fn(Ae, d.ghostClass, !0)), Wt !== g && g !== Ne.active ? Wt = g : g === Ne.active && Wt && (Wt = null), w === g && (g._ignoreWhileAnimating = o), g.animateAll(function() {
        v("dragOverAnimationComplete"), g._ignoreWhileAnimating = null;
      }), g !== w && (w.animateAll(), w._ignoreWhileAnimating = null)), (o === Ae && !Ae.animated || o === l && !o.animated) && (si = null), !d.dragoverBubble && !A.rootEl && o !== document && (Ae.parentNode[pn]._isOutsideThisEl(A.target), !K && Ir(A)), !d.dragoverBubble && A.stopPropagation && A.stopPropagation(), x = !0;
    }
    function h() {
      dn = mn(Ae), vr = mn(Ae, d.draggable), rn({
        sortable: g,
        name: "change",
        toEl: l,
        newIndex: dn,
    ...
    if (Ae.contains(A.target) || o.animated && o.animatingX && o.animatingY || g._ignoreWhileAnimating === o)
      return y(!1);
    if (ra = !1, m && !d.disabled && (T ? S || (u = dt !== it) : Wt === this || (this.lastPutMode = Qo.checkPull(this, m, Ae, A)) && f.checkPut(this, m, Ae, A))) {
      if (b = this._getDirection(A, o) === "vertical", t = It(Ae), v("dragOverValid"), Ne.eventCanceled)
        return x;
      if (u)
        return dt = it, M(), this._hideClone(), v("revert"), Ne.eventCanceled || (Lr ? it.insertBefore(Ae, Lr) : it.appendChild(Ae)), y(!0);
      var E = gs(l, d.draggable);
      if (!E || Xp(A, b, this) && !E.animated) {
        if (E === Ae)
          return y(!1);
        if (E && l === A.target && (o = E), o && (s = It(o)), Ko(it, l, Ae, t, o, s, A, !!o) !== !1)
          return M(), l.appendChild(Ae), dt = l, h(), y(!0);
      } else if (E && Kp(A, b, this)) {
        var C = ci(l, 0, d, !0);
        if (C === Ae)
          return y(!1);
        if (o = C, s = It(o), Ko(it, l, Ae, t, o, s, A, !1) !== !1)
          return M(), l.insertBefore(Ae, C), dt = l, h(), y(!0);
      } else if (o.parentNode === l) {
        s = It(o);
        var R = 0, O, B = Ae.parentNode !== l, F = !Yp(Ae.animated && Ae.toRect || t, o.animated && o.toRect || s, b), z = b ? "top" : "left", I = zf(o, "top", "top") || zf(Ae, "top", "top"), U = I ? I.scrollTop : void 0;
        ...
        if (Q !== !1)
          return (Q === 1 || Q === -1) && (Y = Q === 1), fs = !0, setTimeout(kp, 30), M(), Y && !P ? l.appendChild(Ae) : o.parentNode.insertBefore(Ae, Y ? P : o), I && ud(I, 0, U - I.scrollTop), dt = Ae.parentNode, O !== void 0 && !Go && (qo = Math.abs(O - It(o)[z])), h(), y(!0);
      }
      if (l.contains(Ae))
        return y(!1);
    }
  ...
  _onDrop: function(A) {
    ...
    if (dn = mn(Ae), vr = mn(Ae, o.draggable), ln("drop", this, {
      evt: A
    }), dt = Ae && Ae.parentNode, dn = mn(Ae), vr = mn(Ae, o.draggable), Ne.eventCanceled) {
      this._nulling();
      return;
    }
    ui = !1, Go = !1, ro = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), ds(this.cloneId), ds(this._dragStartId), this.nativeDraggable && (Ye(document, "drop", this), Ye(l, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), _i && Le(document.body, "user-select", ""), Le(Ae, "transform", ""), A && (Ki && (A.cancelable && A.preventDefault(), !o.dropBubble && A.stopPropagation()), He && He.parentNode && He.parentNode.removeChild(He), (it === dt || Wt && Wt.lastPutMode !== "clone") && ct && ct.parentNode && ct.parentNode.removeChild(ct), Ae && (this.nativeDraggable && Ye(Ae, "dragend", this), Il(Ae), Ae.style["will-change"] = "", Ki && !ui && fn(Ae, Wt ? Wt.options.ghostClass : this.options.ghostClass, !1), fn(Ae, this.options.chosenClass, !1), rn({
      sortable: this,
      name: "unchoose",
      toEl: dt,
      newIndex: null,
      ...
      toEl: dt,
      originalEvent: A
    })), Ne.active && ((dn == null || dn === -1) && (dn = fi, vr = to), rn({
      sortable: this,
      name: "end",
      toEl: dt,
      originalEvent: A
  ...
  _nulling: function() {
    ln("nulling", this), it = Ae = dt = He = Lr = ct = Zo = pr = Pr = Rn = Ki = dn = vr = fi = to = si = no = Wt = Qo = Ne.dragged = Ne.ghost = Ne.clone = Ne.active = null, oa.forEach(function(A) {
      A.checked = !0;
    }), oa.length = Ml = Rl = 0;
  },
  ...
  _hideClone: function() {
    if (!pr) {
      if (ln("hideClone", this), Ne.eventCanceled)
        return;
      Le(ct, "display", "none"), this.options.removeCloneOnHide && ct.parentNode && ct.parentNode.removeChild(ct), pr = !0;
    }
  },
  _showClone: function(A) {
    ...
    if (pr) {
      if (ln("showClone", this), Ne.eventCanceled)
        return;
      Ae.parentNode == it && !this.options.group.revertClone ? it.insertBefore(ct, Ae) : Lr ? it.insertBefore(ct, Lr) : it.appendChild(ct), this.options.group.revertClone && this.animate(Ae, ct), Le(ct, "display", ""), pr = !1;
    }
  }
};
function Gp(c) {
...
function Ko(c, A, l, o, t, s, u, d) {
  ...
  return window.CustomEvent && !Jn && !ao ? f = new CustomEvent("move", {
    bubbles: !0,
    cancelable: !0
...
function eh() {
  ...
  return c.prototype = {
    ...
    drop: function() {
      this.sortable.nativeDraggable ? Ye(document, "dragover", this._handleAutoScroll) : (Ye(document, "pointermove", this._handleFallbackAutoScroll), Ye(document, "touchmove", this._handleFallbackAutoScroll), Ye(document, "mousemove", this._handleFallbackAutoScroll)), Vf(), ea(), Bp();
    },
    nulling: function() {
      aa = cs = Xi = vs = Ji = Ll = Nl = null, At.length = 0;
    },
    ...
    _handleAutoScroll: function(l, o) {
      ...
      if (aa = l, o || this.options.forceAutoScrollFallback || ao || Jn || _i) {
        Ol(l, this.options, d, o);
        var f = hr(d, !0);
        vs && (!Ji || s !== Ll || u !== Nl) && (Ji && Vf(), Ji = setInterval(function() {
          var m = hr(document.elementFromPoint(s, u), !0);
          m !== f && (f = m, ea()), Ol(l, t.options, m, o);
        }, 10), Ll = s, Nl = u);
      } else {
        if (!this.options.bubbleScroll || hr(d, !0) === zn()) {
          ea();
          return;
        }
        Ol(l, this.options, hr(d, !1), !1);
      }
    }
  }, Xn(c, {
    pluginName: "scroll",
  ...
  if (!!A.scroll) {
    ...
    do {
      ...
      (At[S].vx != U || At[S].vy != H || At[S].el !== b) && (At[S].el = b, At[S].vx = U, At[S].vy = H, clearInterval(At[S].pid), (U != 0 || H != 0) && (m = !0, At[S].pid = setInterval(function() {
        ...
        typeof T == "function" && T.call(Ne.dragged.parentNode[pn], Y, P, c, aa, At[this.layer].el) !== "continue" || ud(At[this.layer].el, Y, P);
      }.bind({
        layer: S
      }), 24))), S++;
    } while (A.bubbleScroll && w !== f && (w = hr(w, !1)));
    vs = m;
  }
}, 30), gd = function(A) {
...
const ih = /-(\w)/g, oh = rh((c) => c.replace(ih, (A, l) => l.toUpperCase())), md = ["Start", "Add", "Remove", "Update", "End"], yd = ["Choose", "Unchoose", "Sort", "Filter", "Clone"], Ad = ["Move"], ah = [Ad, md, yd].flatMap((c) => c).map((c) => `on${c}`), ps = {
  manage: Ad,
  manageAndEmit: md,
  emit: yd
};
...
function Ed(c) {
  return Object.entries(c).filter(([A, l]) => !xd(A)).map(([A, l]) => [oh(A), l]).filter(([A, l]) => !lh(A));
}
const Gf = ({ el: c }) => c, vh = (c, A) => c.__draggable_context = A, kf = (c) => c.__draggable_context;
class ph {
  constructor({
...
const xh = {
  ...
  methods: {
    ...
    onDragUpdate(c) {
      Fl(c.item), Qf(c.from, c.item, c.oldIndex);
...
const bh = Pn({
  ...
  setup(c) {
    const { menu: A, height: l, mask: o, locale: t } = Ul(c), s = Iv(), u = rl({ active: null });
    Sf("fcx", u), Sf("designer", s);
    ...
    il(() => t.value, (h) => {
      ...
      v.validateForm.rule = x(bf, T.value, { t: g }), v.baseForm.rule = x(Gi, f.value, { t: g }), v.form.rule = x(Ef, S.value, { t: g }), v.cacheProps = {};
    ...
    const y = {
      ...
      getRule() {
        return y.parseRule(cr(v.dragForm.api.rule[0].children));
      },
      getJson() {
        return Lt.toJson(y.getRule());
      },
      getOption() {
        const h = cr(v.form.value);
      ...
      setRule(h) {
        h || (h = []), v.children = Zi(y.loadRule(xt.String(h) ? Lt.parseJson(h) : cr(h))), y.clearActiveRule(), v.dragForm.rule = y.makeDragRule(y.makeChildren(v.children));
      },
      ...
      loadRule(h) {
        ...
        return h.forEach((C) => {
          if (xt.String(C))
            return E.push(C);
          const R = dr[C._fc_drag_tag] || dr[C.type];
      ...
      toolActive(h) {
        y.unWatchActiveRule(), v.activeRule && (delete v.propsForm.api[v.activeRule._id], delete v.baseForm.api[v.activeRule._id], delete v.validateForm.api[v.activeRule._id], delete v.dragForm.api.activeRule), v.activeRule = h, v.dragForm.api.activeRule = h, Nr(() => {
          v.activeTab = "props", Nr(() => {
      ...
      updateRuleFormData() {
        const h = v.activeRule, E = { ...h.props, formCreateChild: cr(h.children[0]) };
        Object.keys(h).forEach((C) => {
          ["effect", "config", "payload", "id", "type"].indexOf(C) < 0 && (E["formCreate" + oo(C)] = cr(h[C]));
        }), ["props", "effect", "attrs"].forEach((C) => {
          h[C] && Object.keys(h[C]).forEach((R) => {
            E["formCreate" + oo(C) + ">" + R] = cr(h[C][R]);
          });
        }), v.propsForm.value = E, v.showBaseRule = nd(h, "field") && h.input !== !1 && (!d.value || d.value.showBaseForm !== !1), v.showBaseRule && (v.baseForm.value = {
          field: h.field,
          title: h.title || "",
          info: h.info,
          _control: h._control
      ...
      makeRule(h, E) {
        ...
        C.config = { config: h }, h.component && (C.component = Zf(h.component)), C.effect || (C.effect = {}), C.effect._fc = !0, C._fc_drag_tag = h.name;
        let R;
        if (h.drag && C.children.push(R = y.makeDrag(h.drag, C.type, y.makeChildren([]), {
          ...
          for (let B = 0; B < (h.childrenLen || 1); B++) {
            const F = y.makeRule(dr[h.children]);
            (R || C).children.push(F);
          }
        ...
        return h.inside ? (C.children = y.makeChildren([{
          ...
          on: {
            ...
            addChild: ({ self: B }) => {
              const F = y.getParent(B), z = F.parent.config.config, I = dr[z.children];
          ...
          on: {
            ...
            addChild: ({ self: B }) => {
              const F = B.children[0].config.config, z = dr[F.children];
...
}), Ch = { class: "_fc-l-title" }, Th = { class: "_fc-l-item" }, wh = { class: "_fc-l-icon" }, Dh = { class: "_fc-l-name" }, Mh = { class: "_fc-m-drag" };
function Rh(c, A, l, o, t, s) {
  const u = ht("draggable"), d = ht("el-aside"), f = ht("DragForm"), m = ht("ElMain"), T = ht("ElContainer"), S = ht("el-header"), w = ht("ElDivider"), b = ht("ElAside"), g = ht("ViewForm"), x = ht("ElDialog");
  return et(), Hn(T, {
    class: "_fc-designer",
    style: Lv("height:" + c.dragHeight)
  }, {
    default: nt(() => [
      _e(m, null, {
        default: nt(() => [
          _e(T, { style: { height: "100%" } }, {
            default: nt(() => [
              _e(d, {
                class: "_fc-l",
                width: "266px"
                ...
                default: nt(() => [
                  (et(!0), Gt(_f, null, ed(c.menuList, (v, M) => (et(), Gt("div", {
                    key: M,
                    class: "_fc-l-group"
                  }, [
                    gt("h4", Ch, cn(v.title), 1),
                    _e(u, {
                      ...
                      item: nt(({ element: y }) => [
                        gt("div", Th, [
                          gt("div", wh, [
                            gt("i", {
                              class: Xo(["fc-icon", y.icon || "icon-input"])
                            }, null, 2)
                          ]),
                          gt("span", Dh, cn(c.t("components." + y.name + ".name") || y.label), 1)
                        ])
                      ]),
                      _: 2
                    }, 1032, ["list"])
              ...
              _e(T, { class: "_fc-m" }, {
                default: nt(() => [
                  _e(m, { style: { background: "#F5F5F5", padding: "20px" } }, {
                    default: nt(() => [
                      gt("div", Mh, [
                        _e(f, {
                          ...
                          option: c.form.value,
                          api: c.dragForm.api,
                          "onUpdate:api": A[0] || (A[0] = (v) => c.dragForm.api = v)
              ...
              !c.config || c.config.showConfig !== !1 ? (et(), Hn(b, {
                key: 0,
                class: "_fc-r",
                width: "320px"
              }, {
                  ...
                  _e(T, { style: { height: "100%" } }, {
                    default: nt(() => [
                      _e(S, {
                        ...
                        default: nt(() => [
                          !!c.activeRule || c.config && c.config.showFormConfig === !1 ? (et(), Gt("div", {
                            key: 0,
                            class: Xo(["_fc-r-tab", { active: c.activeTab === "props" }]),
                            onClick: A[1] || (A[1] = (v) => c.activeTab = "props")
                          }, cn(c.t("designer.config.component")), 3)) : vn("", !0),
                          !c.config || c.config.showFormConfig !== !1 ? (et(), Gt("div", {
                            key: 1,
                            class: Xo(["_fc-r-tab", { active: c.activeTab === "form" && !!c.activeRule }]),
                            onClick: A[2] || (A[2] = (v) => c.activeTab = "form")
                          }, cn(c.t("designer.config.form")), 3)) : vn("", !0)
                        ]),
                        _: 1
                      }),
                      !c.config || c.config.showFormConfig !== !1 ? jo((et(), Hn(m, { key: 0 }, {
                        default: nt(() => [
                          _e(f, {
                            rule: c.form.rule,
                            option: c.form.option,
                            modelValue: c.form.value.form,
                            "onUpdate:modelValue": A[3] || (A[3] = (v) => c.form.value.form = v),
                            api: c.form.api,
                            "onUpdate:api": A[4] || (A[4] = (v) => c.form.api = v)
                      ...
                      jo((et(), Hn(m, {
                        ...
                        default: nt(() => [
                          gt("div", null, [
                            c.showBaseRule ? (et(), Hn(w, { key: 0 }, {
                              default: nt(() => [
                                Or(cn(c.t("designer.config.rule")), 1)
                              ]),
                              _: 1
                            })) : vn("", !0),
                            jo(_e(f, {
                              api: c.baseForm.api,
                              "onUpdate:api": A[5] || (A[5] = (v) => c.baseForm.api = v),
                            ...
                            _e(w, null, {
                              default: nt(() => [
                                Or(cn(c.t("designer.config.props")), 1)
                              ]),
                              _: 1
                            }),
                            _e(f, {
                              api: c.propsForm.api,
                              "onUpdate:api": A[6] || (A[6] = (v) => c.propsForm.api = v),
                            ...
                            c.showBaseRule ? (et(), Hn(w, { key: 1 }, {
                              default: nt(() => [
                                Or(cn(c.t("designer.config.validate")), 1)
                              ]),
                              _: 1
                            })) : vn("", !0),
                            jo(_e(f, {
                              api: c.validateForm.api,
                              "onUpdate:api": A[7] || (A[7] = (v) => c.validateForm.api = v),
              ...
              _e(x, {
                ...
                "onUpdate:modelValue": A[8] || (A[8] = (v) => c.preview.state = v),
                width: "800px",
                "append-to-body": ""
              }, {
                default: nt(() => [
                  c.preview.state ? (et(), Hn(g, {
                    key: 0,
                    rule: c.preview.rule,
...
const mr = /* @__PURE__ */ gr(bh, [["render", Rh]]);
let Ph = 1;
const Ih = Pn({
  name: "DragTool",
  props: ["dragBtn", "children", "unique", "mask"],
  setup(c) {
    const { unique: A } = Ul(c), l = io(() => A.value || Ph++), o = Nv("fcx");
    return {
      id: l,
      state: o
    };
  ...
  style: { cursor: "move" }
}, Fh = /* @__PURE__ */ gt("i", { class: "fc-icon icon-move" }, null, -1), Bh = [
  Fh
], Hh = { class: "drag-r" }, Uh = /* @__PURE__ */ gt("i", { class: "fc-icon icon-add" }, null, -1), zh = [
  Uh
], Wh = /* @__PURE__ */ gt("i", { class: "fc-icon icon-copy" }, null, -1), jh = [
  Wh
], $h = /* @__PURE__ */ gt("i", { class: "fc-icon icon-add-child" }, null, -1), Yh = [
  $h
], Vh = /* @__PURE__ */ gt("i", { class: "fc-icon icon-delete" }, null, -1), Qh = [
  Vh
];
function Gh(c, A, l, o, t, s) {
  return et(), Gt("div", {
    class: Xo(["drag-tool", { active: c.state.active === c.id }]),
    onClick: A[4] || (A[4] = Ov((...u) => c.active && c.active(...u), ["stop"]))
  }, [
    c.mask ? (et(), Gt("div", Lh)) : vn("", !0),
    gt("div", Nh, [
      c.state.active === c.id && c.dragBtn !== !1 ? (et(), Gt("div", Oh, Bh)) : vn("", !0)
    ]),
    gt("div", Hh, [
      gt("div", {
        class: "drag-btn",
...
const kh = /* @__PURE__ */ gr(Ih, [["render", Gh]]);
var Kh = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Hl = { exports: {} }, Xf;
function Dd() {
    ...
    (function(l, o) {
      ...
      var Ee = function() {
        ...
        return function(W, V) {
          ...
          for (var Ze = 0; Ze < Z; ++Ze) {
            var Mt = J[Ze];
            if (Mt == ",")
              J[Ze] = "N";
            else if (Mt == "%") {
              var rt = void 0;
              for (rt = Ze + 1; rt < Z && J[rt] == "%"; ++rt)
                ;
              for (var an = Ze && J[Ze - 1] == "!" || rt < Z && J[rt] == "1" ? "1" : "N", en = Ze; en < rt; ++en)
                J[en] = an;
              Ze = rt - 1;
            }
          }
          for (var vt = 0, tn = k; vt < Z; ++vt) {
            var Ot = J[vt];
            tn == "L" && Ot == "1" ? J[vt] = "L" : p.test(Ot) && (tn = Ot);
          }
          for (var yt = 0; yt < Z; ++yt)
            if (a.test(J[yt])) {
              var pt = void 0;
              for (pt = yt + 1; pt < Z && a.test(J[pt]); ++pt)
                ;
              for (var st = (yt ? J[yt - 1] : k) == "L", nn = (pt < Z ? J[pt] : k) == "L", oi = st == nn ? st ? "L" : "R" : k, fr = yt; fr < pt; ++fr)
                J[fr] = oi;
              yt = pt - 1;
            }
          for (var zt = [], Bn, Rt = 0; Rt < Z; )
            if (D.test(J[Rt])) {
              ...
              for (var Vt = kn; Vt < Rt; )
                if (L.test(J[Vt])) {
                  kn < Vt && (zt.splice(Mr, 0, new N(1, kn, Vt)), Mr += Rr);
                  var ai = Vt;
                  for (++Vt; Vt < Rt && L.test(J[Vt]); ++Vt)
                    ;
                  zt.splice(Mr, 0, new N(2, ai, Vt)), Mr += Rr, kn = Vt;
                } else
                  ++Vt;
              kn < Rt && zt.splice(Mr, 0, new N(1, kn, Rt));
            }
...
`, n);
        ...
        return e.split(/\r\n?|\n/);
      }, er = window.getSelection ? function(e) {
        try {
      ...
      var tr = {};
      function zr(e, n) {
        var i = tr.hasOwnProperty(e) ? tr[e] : tr[e] = {};
        se(n, i);
      }
      function Ln(e, n) {
        if (n === !0)
      ...
      function Cs(e, n, i) {
        if (!n.styles || n.styles[0] != e.state.modeGen) {
          var r = yi(e, j(n)), a = n.text.length > e.options.maxHighlightLength && Ln(e.doc.mode, r.state), p = bs(e, n, r);
      ...
      function yi(e, n, i) {
        ...
        if (!r.mode.startState)
          return new Nn(r, !0, n);
        var p = Id(e, n, i), D = p > r.first && we(r, p - 1).stateAfter, L = D ? Nn.fromSaved(r, D, p) : new Nn(r, Wr(r.mode), p);
      ...
      function fa(e, n, i, r) {
        ...
        for (p.start = p.pos = r || 0, n == "" && Ts(a, i.state); !p.eol(); )
      ...
      function Ds(e, n, i, r) {
        ...
        for (r && (V = []); (r || W.pos < n.ch) && !W.eol(); )
          W.start = W.pos, D = da(p, W, N.state), r && V.push(new ws(W, D, Ln(a.mode, N.state)));
        return r ? V : new ws(W, D, N.state);
      }
      function Ms(e, n) {
        if (e)
          for (; ; ) {
      ...
      function Rs(e, n, i, r, a, p, D) {
        ...
        for (n == "" && Ms(Ts(i, r.state), p); !V.eol(); ) {
          if (V.pos > e.options.maxHighlightLength ? (L = !1, D && fa(e, n, r, V.pos), V.pos = n.length, k = null) : k = Ms(da(i, V, r.state, Z), p), Z) {
            var J = Z[0].name;
            J && (k = "m-" + (k ? J + " " + k : J));
          }
          if (!L || W != k) {
      ...
      function ca(e, n) {
        ...
        if (!i && !r)
          return null;
        var a = n.from.ch, p = n.to.ch, D = ye(n.from, n.to) == 0, L = Hd(i, a, D), N = Ud(r, p, D), W = n.text.length == 1, V = Ue(n.text).length + (W ? a : 0);
        if (L)
      ...
      function zs(e, n) {
        ...
        for (var a = 0; a <= (n.rest ? n.rest.length : 0); a++) {
          ...
          r.pos = 0, r.addToken = Kd, _n(e.display.measure) && (D = oe(p, e.doc.direction)) && (r.addToken = Jd(r.addToken, D)), r.map = [];
          var L = n != e.display.externalMeasured && j(p);
          Zd(p, r, Cs(e, p, L)), p.styleClasses && (p.styleClasses.bgClass && (r.bgClass = _(p.styleClasses.bgClass, r.bgClass || "")), p.styleClasses.textClass && (r.textClass = _(p.styleClasses.textClass, r.textClass || ""))), r.map.length == 0 && r.map.push(0, 0, r.content.appendChild(so(e.display.measure))), a == 0 ? (n.measure.map = r.map, n.measure.cache = {}) : ((n.measure.maps || (n.measure.maps = [])).push(r.map), (n.measure.caches || (n.measure.caches = [])).push({}));
        }
        if (T) {
      ...
      function Kd(e, n, i, r, a, p, D) {
        if (!!n) {
          var L = e.splitSpaces ? Xd(n, e.trailingSpace) : n, N = e.cm.state.specialChars, W = !1, V;
          if (!N.test(n))
...
` ? (ie = V.appendChild(P("span", Z[0] == "\r" ? "\u240D" : "\u2424", "cm-invalidchar")), ie.setAttribute("cm-text", Z[0]), e.col += 1) : (ie = e.cm.options.specialCharPlaceholder(Z[0]), ie.setAttribute("cm-text", Z[0]), f && m < 9 ? V.appendChild(P("span", [ie])) : V.appendChild(ie), e.col += 1);
      ...
      function Zd(e, n, i) {
        ...
        if (!r) {
          for (var D = 1; D < i.length; D += 2)
            n.addToken(n, a.slice(p, p = i[D]), Us(i[D + 1], n.cm.options));
          return;
        }
        for (var L = a.length, N = 0, W = 1, V = "", k, Z, J = 0, te, ie, de, he, xe; ; ) {
            ...
            for (var ge = [], Te = void 0, Re = 0; Re < r.length; ++Re) {
              ...
              if (Be.type == "bookmark" && Me.from == N && Be.widgetNode)
                ...
                if (Me.to != null && Me.to != N && J > Me.to && (J = Me.to, ie = ""), Be.className && (te += " " + Be.className), Be.css && (Z = (Z ? Z + ";" : "") + Be.css), Be.startStyle && Me.from == N && (de += " " + Be.startStyle), Be.endStyle && Me.to == J && (Te || (Te = [])).push(Be.endStyle, Me.to), Be.title && ((xe || (xe = {})).title = Be.title), Be.attributes)
                  for (var Ze in Be.attributes)
                    (xe || (xe = {}))[Ze] = Be.attributes[Ze];
          ...
          if (N >= L)
            break;
          for (var an = Math.min(L, J); ; ) {
            if (V) {
              var en = N + V.length;
              if (!he) {
                var vt = en > an ? V.slice(0, an - N) : V;
                n.addToken(
                  n,
                  vt,
                  k ? k + te : te,
            ...
            V = a.slice(p, p = i[W++]), k = Us(i[W++], n.cm.options);
          }
        }
      }
      function js(e, n, i) {
        this.line = n, this.rest = $d(n), this.size = this.rest ? j(Ue(this.rest)) - i + 1 : 1, this.node = this.text = null, this.hidden = nr(e, n);
      }
      function mo(e, n, i) {
        for (var r = [], a, p = n; p < i; p = a) {
          var D = new js(e.doc, we(e.doc, p), p);
          a = p + D.size, r.push(D);
        }
        return r;
      }
      ...
      function $s(e, n, i, r) {
        for (var a = 0; a < n.changes.length; a++) {
          var p = n.changes[a];
          p == "text" ? rc(e, n) : p == "gutter" ? Vs(e, n, i, r) : p == "class" ? ma(e, n) : p == "widget" && ic(e, n, r);
        }
        n.changes = null;
      }
      function Si(e) {
      ...
      function oc(e, n, i, r) {
        var a = Ys(e, n);
        return n.text = n.node = a.pre, a.bgClass && (n.bgClass = a.bgClass), a.textClass && (n.textClass = a.textClass), ma(e, n), Vs(e, n, i, r), Qs(e, n, r), n.node;
      }
      function Qs(e, n, i) {
      ...
      function Gs(e, n, i, r, a) {
        if (!!n.widgets)
          for (var p = Si(i), D = 0, L = n.widgets; D < L.length; ++D) {
            ...
            N.handleMouseEvents || W.setAttribute("cm-ignore-events", "true"), ac(N, W, i, r), e.display.input.setUneditable(W), a && N.above ? p.insertBefore(W, i.gutter || i.text) : p.appendChild(W), Tt(N, "redraw");
          }
      }
      function ac(e, n, i, r) {
        if (e.noHScroll) {
      ...
      function Vr(e, n) {
        var i = j(n), r = xa(e, i);
        r && !r.text ? r = null : r && r.changes && ($s(e, r, i, Ta(e)), e.curOp.forceUpdate = !0), r || (r = sc(e, n));
        var a = Ks(r, n, i);
        return {
          line: n,
          view: r,
      ...
      function Fn(e, n, i, r, a) {
        n.before && (i = -1);
        var p = i + (r || ""), D;
        return n.cache.hasOwnProperty(p) ? D = n.cache[p] : (n.rect || (n.rect = n.view.text.getBoundingClientRect()), n.hasHeights || (lc(e, n.view, n.rect), n.hasHeights = !0), D = fc(e, n, i, r), D.bogus || (n.cache[p] = D)), {
          left: D.left,
          right: D.right,
          top: a ? D.rtop : D.top,
      ...
      function fc(e, n, i, r) {
        var a = Zs(n.map, i, r), p = a.node, D = a.start, L = a.end, N = a.collapse, W;
        if (p.nodeType == 3) {
          for (var V = 0; V < 4; V++) {
            ...
            for (; a.coverStart + L < a.coverEnd && Ke(n.line.text.charAt(a.coverStart + L)); )
              ++L;
            if (f && m < 9 && D == 0 && L == a.coverEnd - a.coverStart ? W = p.parentNode.getBoundingClientRect() : W = uc(Q(p, D, L).getClientRects(), r), W.left || W.right || D == 0)
              break;
            L = D, D = D - 1, N = "right";
          }
          f && m < 11 && (W = dc(e.display.measure, W));
        } else {
          D > 0 && (N = r = "right");
          var k;
      ...
      function Ao(e, n, i, r, a) {
        ...
        if (r == "local" ? D += yo(e.display) : D -= e.display.viewOffset, r == "page" || r == "window") {
          ...
          D += L.top + (r == "window" ? 0 : tu(Se(e)));
          var N = L.left + (r == "window" ? 0 : eu(Se(e)));
          i.left += N, i.right += N;
        }
      ...
      function xo(e, n, i, r, a) {
        return r || (r = we(e.doc, n.line)), Ao(e, r, Xs(e, r, n.ch, a), i);
      }
      ...
      function ba(e, n, i) {
        ...
        n < 0 && (n = 0);
        for (var D = we(r, a); ; ) {
          var L = cc(e, D, a, n, i), N = Wd(D, L.ch + (L.xRel > 0 || L.outside > 0 ? 1 : 0));
          if (!N)
            return L;
          var W = N.find(1);
          if (W.line == a)
      ...
      function cc(e, n, i, r, a) {
        ...
        if (V) {
          var k = (e.options.lineWrapping ? pc : vc)(e, n, i, p, V, r, a);
      ...
      function pc(e, n, i, r, a, p, D) {
        var L = iu(e, n, r, D), N = L.begin, W = L.end;
      ...
      function Qr(e) {
        ...
        if (Sr == null) {
          Sr = P("pre", null, "CodeMirror-line-like");
          for (var n = 0; n < 49; ++n)
            Sr.appendChild(document.createTextNode("x")), Sr.appendChild(P("br"));
      ...
      function qt(e, n, i, r) {
        ...
        if (r && i < a.viewTo && (a.updateLineNumbers == null || a.updateLineNumbers > n) && (a.updateLineNumbers = n), e.curOp.viewChanged = !0, n >= a.viewTo)
          $n && pa(e.doc, n) < a.viewTo && ir(e);
        else if (i <= a.viewFrom)
          $n && Hs(e.doc, i + r) > a.viewFrom ? ir(e) : (a.viewFrom += r, a.viewTo += r);
        else if (n <= a.viewFrom && i >= a.viewTo)
          ir(e);
        else if (n <= a.viewFrom) {
          var p = So(e, i, i + r, 1);
          p ? (a.view = a.view.slice(p.index), a.viewFrom = p.lineN, a.viewTo += r) : ir(e);
        } else if (i >= a.viewTo) {
          var D = So(e, n, n, -1);
          D ? (a.view = a.view.slice(0, D.index), a.viewTo = D.lineN) : ir(e);
        } else {
          var L = So(e, n, n, -1), N = So(e, i, i + r, 1);
          L && N ? (a.view = a.view.slice(0, L.index).concat(mo(e, L.lineN, N.lineN)).concat(a.view.slice(N.index)), a.viewTo += r) : ir(e);
        }
      ...
      function So(e, n, i, r) {
        var a = br(e, n), p, D = e.display.view;
      ...
      function hc(e, n, i) {
        ...
        a.length == 0 || n >= r.viewTo || i <= r.viewFrom ? (r.view = mo(e, n, i), r.viewFrom = n) : (r.viewFrom > n ? r.view = mo(e, n, r.viewFrom).concat(r.view) : r.viewFrom < n && (r.view = r.view.slice(br(e, n))), r.viewFrom = n, r.viewTo < i ? r.view = r.view.concat(mo(e, r.viewTo, i)) : r.viewTo > i && (r.view = r.view.slice(0, br(e, i)))), r.viewTo = i;
      }
      function lu(e) {
      ...
      function gc(e, n, i) {
        var r = e.display, a = e.doc, p = document.createDocumentFragment(), D = ks(e.display), L = D.left, N = Math.max(r.sizerWidth, xr(e) - r.sizer.offsetLeft) - D.right, W = a.direction == "ltr";
        ...
        function k(ge, Te, Re) {
          var Me = we(a, ge), Be = Me.text.length, Ze, Mt;
          function rt(vt, tn) {
            return xo(e, ee(ge, vt), "div", Me, tn);
          }
          function an(vt, tn, Ot) {
            var yt = ou(e, Me, null, vt), pt = tn == "ltr" == (Ot == "after") ? "left" : "right", st = Ot == "after" ? yt.begin : yt.end - (/\s/.test(Me.text.charAt(yt.end - 1)) ? 2 : 1);
            return rt(st, pt)[pt];
          }
          var en = oe(Me, a.direction);
          return Ce(en, Te || 0, Re == null ? Be : Re, function(vt, tn, Ot, yt) {
            var pt = Ot == "ltr", st = rt(vt, pt ? "left" : "right"), nn = rt(tn - 1, pt ? "right" : "left"), oi = Te == null && vt == 0, fr = Re == null && tn == Be, zt = yt == 0, Bn = !en || yt == en.length - 1;
            if (nn.top - st.top <= 3) {
              var Rt = (W ? oi : fr) && zt, tl = (W ? fr : oi) && Bn, kn = Rt ? L : (pt ? st : nn).left, Mr = tl ? N : (pt ? nn : st).right;
              V(kn, st.top, Mr - kn, st.bottom);
            } else {
              var Rr, Vt, ai, nl;
              pt ? (Rr = W && oi && zt ? L : st.left, Vt = W ? N : an(vt, Ot, "before"), ai = W ? L : an(tn, Ot, "after"), nl = W && fr && Bn ? N : nn.right) : (Rr = W ? an(vt, Ot, "before") : L, Vt = !W && oi && zt ? N : st.right, ai = !W && fr && Bn ? L : nn.left, nl = W ? an(tn, Ot, "after") : N), V(Rr, st.top, Vt - Rr, st.bottom), st.bottom < nn.top && V(L, st.bottom, null, nn.top), V(ai, nn.top, nl - ai, nn.bottom);
            }
            (!Ze || Eo(st, Ze) < 0) && (Ze = st), Eo(nn, Ze) < 0 && (Ze = nn), (!Mt || Eo(st, Mt) < 0) && (Mt = st), Eo(nn, Mt) < 0 && (Mt = nn);
          }), { start: Ze, end: Mt };
        }
        var Z = n.from(), J = n.to();
        if (Z.line == J.line)
      ...
      function bo(e) {
        for (var n = e.display, i = n.lineDiv.offsetTop, r = Math.max(0, n.scroller.getBoundingClientRect().top), a = n.lineDiv.getBoundingClientRect().top, p = 0, D = 0; D < n.view.length; D++) {
          ...
          if (!L.hidden) {
            ...
            if ((J > 5e-3 || J < -5e-3) && (a < r && (p -= J), sn(L.line, W), fu(L.line), L.rest))
      ...
      function yc(e, n, i, r) {
        ...
        for (var p = 0; p < 5; p++) {
          ...
          if (W.scrollTop != null && (wi(e, W.scrollTop), Math.abs(e.doc.scrollTop - V) > 1 && (D = !0)), W.scrollLeft != null && (Cr(e, W.scrollLeft), Math.abs(e.doc.scrollLeft - k) > 1 && (D = !0)), !D)
            break;
        }
        return a;
      }
      ...
      function wi(e, n) {
        Math.abs(e.doc.scrollTop - n) < 2 || (t || Fa(e, { top: n }), cu(e, n, !0), t && Fa(e), Ri(e, 100));
      }
      function cu(e, n, i) {
      ...
      function Xr(e, n) {
        ...
        for (var a = 0; a < 4 && i != e.display.barWidth || r != e.display.barHeight; a++)
          i != e.display.barWidth && e.options.lineWrapping && bo(e), vu(e, Di(e)), i = e.display.barWidth, r = e.display.barHeight;
      }
      function vu(e, n) {
      ...
      function hu(e) {
        e.display.scrollbars && (e.display.scrollbars.clear(), e.display.scrollbars.addClass && U(e.display.wrapper, e.display.scrollbars.addClass)), e.display.scrollbars = new pu[e.options.scrollbarStyle](function(n) {
      ...
      function bc(e) {
        ...
        Rc(n), e.updateMaxLine && ga(n), e.mustUpdate = e.viewChanged || e.forceUpdate || e.scrollTop != null || e.scrollToPos && (e.scrollToPos.from.line < i.viewFrom || e.scrollToPos.to.line >= i.viewTo) || i.maxLineChanged && n.options.lineWrapping, e.update = e.mustUpdate && new wo(n, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate);
      }
      function Cc(e) {
      ...
      function wc(e) {
        ...
        e.preparedSelection && n.display.input.showSelection(e.preparedSelection, i), (e.updatedDisplay || e.startHeight != n.doc.height) && Xr(n, e.barMeasure), e.updatedDisplay && Ha(n, e.barMeasure), e.selectionChanged && Ra(n), n.state.focused && e.updateInput && n.display.input.reset(e.typing), i && uu(e.cm);
      }
      function Dc(e) {
        ...
        if (!(n.highlightFrontier >= e.display.viewTo)) {
          ...
          n.iter(r.line, Math.min(n.first + n.size, e.display.viewTo + 500), function(p) {
            if (r.line >= e.display.viewFrom) {
              var D = p.styles, L = p.text.length > e.options.maxHighlightLength ? Ln(n.mode, r.state) : null, N = bs(e, p, r, !0);
          ...
          }), n.highlightFrontier = r.line, n.modeFrontier = Math.max(n.modeFrontier, r.line), a.length && on(e, function() {
      ...
      var wo = function(e, n, i) {
        var r = e.display;
        this.viewport = n, this.visible = Co(r, e.doc, n), this.editorIsHidden = !r.wrapper.offsetWidth, this.wrapperHeight = r.wrapper.clientHeight, this.wrapperWidth = r.wrapper.clientWidth, this.oldDisplayWidth = xr(e), this.force = i, this.dims = Ta(e), this.events = [];
      };
      wo.prototype.signal = function(e, n) {
        Je(e, n) && this.events.push(arguments);
        ...
        for (var N = r.view, W = r.viewFrom, V = 0; V < N.length; V++) {
          ...
          if (!k.hidden)
            if (!k.node || k.node.parentNode != p) {
              ...
              k.changes && (be(k.changes, "gutter") > -1 && (J = !1), $s(e, k, W, i)), J && (H(k.lineNumber), k.lineNumber.appendChild(document.createTextNode(fe(e.options, W)))), D = k.node.nextSibling;
            }
          W += k.size;
        }
        for (; D; )
      ...
      function Su(e, n) {
        ...
        if (!!(r && N || a && W)) {
          ...
          if (r && !t && !g && p != null) {
            a && W && wi(e, Math.max(0, L.scrollTop + a * p)), Cr(e, Math.max(0, L.scrollLeft + r * p)), (!a || a && W) && mt(n), D.wheelStartX = null;
            return;
          }
          if (a && p != null) {
      ...
      un.prototype.primary = function() {
        ...
        for (var e = 0; e < this.ranges.length; e++)
          if (!this.ranges[e].empty())
            return !0;
        return !1;
      }, un.prototype.contains = function(e, n) {
        n || (n = e);
      ...
      function Eu(e, n) {
        ...
        return e.line == n.to.line && (r += ar(n).ch - n.to.ch), ee(i, r);
      }
      function za(e, n) {
      ...
      function Fc(e, n, i) {
        for (var r = [], a = ee(e.first, 0), p = a, D = 0; D < n.length; D++) {
          var L = n[D], N = bu(L.from, a, p), W = bu(ar(L), a, p);
        ...
        return new un(r, e.sel.primIndex);
      }
      function Wa(e) {
      ...
      function Tu(e, n) {
        ...
        e.doc = n, n.cm = e, Da(e), Wa(e), wu(e), e.options.direction = n.direction, e.options.lineWrapping || ga(e), e.options.mode = n.modeOption, qt(e);
      }
      function wu(e) {
      ...
      function $a(e, n) {
        var i = { from: Ct(n.from), to: ar(n), text: jn(e, n.from, n.to) };
        return Ru(e, i, n.from.line, n.to.line + 1), lr(e, function(r) {
      ...
      function Mu(e, n, i, r) {
        ...
        a.undone.length = 0;
        var p = +new Date(), D, L;
        if ((a.lastOp == r || a.lastOrigin == n.origin && n.origin && (n.origin.charAt(0) == "+" && a.lastModTime > p - (e.cm ? e.cm.options.historyEventDelay : 500) || n.origin.charAt(0) == "*")) && (D = Hc(a, a.lastOp == r)))
          L = Ue(D.changes), ye(n.from, n.to) == 0 && ye(n.from, L.to) == 0 ? L.to = ar(n) : D.changes.push($a(e, n));
        else {
          var N = Ue(a.done);
      ...
      function zc(e, n, i, r) {
        ...
        i == a.lastSelOp || p && a.lastSelOrigin == p && (a.lastModTime == a.lastSelTime && a.lastOrigin == p || Uc(e, p, Ue(a.done), n)) ? a.done[a.done.length - 1] = n : Ro(n, a.done), a.lastSelTime = +new Date(), a.lastSelOrigin = p, a.lastSelOp = i, r && r.clearRedo !== !1 && Du(a.undone);
      }
      function Ro(e, n) {
        var i = Ue(n);
      ...
      function Jr(e, n, i) {
        for (var r = [], a = 0; a < e.length; ++a) {
          var p = e[a];
          if (p.ranges) {
            r.push(i ? un.prototype.deepCopy.call(p) : p);
            continue;
          }
          var D = p.changes, L = [];
          r.push({ changes: L });
      ...
      function Po(e, n, i, r, a) {
        a == null && (a = e.cm && (e.cm.display.shift || e.extend)), Ut(e, new un([Ya(e.sel.primary(), n, i, a)], 0), r);
      }
      function Iu(e, n, i) {
      ...
      function Io(e, n, i) {
        (Je(e, "beforeSelectionChange") || e.cm && Je(e.cm, "beforeSelectionChange")) && (n = $c(e, n, i));
          ...
          for (var D = 0; D < p.markedSpans.length; ++D) {
            ...
            if ((L.from == null || (W ? L.from <= n.ch : L.from < n.ch)) && (L.to == null || (V ? L.to >= n.ch : L.to > n.ch))) {
              ...
              if (i) {
                ...
                if ((r < 0 ? V : W) && (k = Hu(e, k, -r, k && k.line == n.line ? p : null)), k && k.line == n.line && (Z = ye(k, i)) && (r < 0 ? Z < 0 : Z > 0))
                  return Zr(e, k, n, r, a);
              }
              var J = N.find(r < 0 ? -1 : 1);
              return (r < 0 ? W : V) && (J = Hu(e, J, r, J.line == n.line ? p : null)), J ? Zr(e, J, n, r, a) : null;
            }
          }
        return n;
      }
      ...
      function qr(e, n, i) {
        ...
        if (!((Je(e, "beforeChange") || e.cm && Je(e.cm, "beforeChange")) && (n = zu(e, n, !0), !n))) {
      ...
      function Wu(e, n) {
        if (!(n.text.length == 1 && n.text[0] == "" && ye(n.from, n.to) == 0)) {
          var i = za(e, n);
          Mu(e, n, i, e.cm ? e.cm.curOp.id : NaN), Li(e, n, i, ca(e, n));
          var r = [];
          lr(e, function(a, p) {
            !p && be(r, a.history) == -1 && (Vu(a.history, n), r.push(a.history)), Li(a, n, null, ca(a, n));
          });
        }
      }
      function No(e, n, i) {
        ...
        if (!(r && !i)) {
          ...
          if (W != L.length) {
            ...
            for (var k = Je(e, "beforeChange") || e.cm && Je(e.cm, "beforeChange"), Z = function(ie) {
              var de = p.changes[ie];
              if (de.origin = n, k && !zu(e, de, !1))
                return L.length = 0, {};
              V.push($a(e, de));
              var he = ie ? za(e, de) : Ue(L);
              Li(e, de, he, Pu(e, de)), !ie && e.cm && e.cm.scrollIntoView({ from: de.from, to: ar(de) });
              var xe = [];
              lr(e, function(ge, Te) {
      ...
      function ju(e, n) {
        if (n != 0 && (e.first += n, e.sel = new un(Ht(e.sel.ranges, function(a) {
          return new Qe(
      ...
      function Li(e, n, i, r) {
        ...
        if (!(n.from.line > e.lastLine())) {
          ...
          n.to.line > p && (n = {
            ...
            text: [n.text[0]],
            origin: n.origin
          }), n.removed = jn(e, n.from, n.to), i || (i = za(e, n)), e.cm ? Yc(e.cm, n, r) : ja(e, n, r), Io(e, i, Nt), e.cantEdit && Lo(e, ee(e.firstLine(), 0)) && (e.cantEdit = !1);
        }
      }
      function Yc(e, n, i) {
        ...
        e.options.lineWrapping || (N = j(Tn(we(r, p.line))), r.iter(N, D.line + 1, function(J) {
          if (J == a.maxLine)
            return L = !0, !0;
        })), r.sel.contains(n.from, n.to) > -1 && at(e), ja(r, n, i, au(e)), e.options.lineWrapping || (r.iter(N, p.line + n.text.length, function(J) {
          var te = go(J);
          te > a.maxLineLength && (a.maxLine = J, a.maxLineLength = te, a.maxLineChanged = !0, L = !1);
        }), L && (e.curOp.updateMaxLine = !0)), Ld(r, p.line), Ri(e, 400);
        var W = n.text.length - (D.line - p.line) - 1;
        n.full ? qt(e) : p.line == D.line && n.text.length == 1 && !Cu(e.doc, n) ? rr(e, p.line, "text") : qt(e, p.line, D.line + 1, W);
        var V = Je(e, "changes"), k = Je(e, "change");
        if (k || V) {
          var Z = {
            from: p,
            to: D,
        ...
        for (var a = 0; a < e.length; ++a) {
          ...
          if (p.ranges) {
            ...
            for (var L = 0; L < p.ranges.length; L++)
              $u(p.ranges[L].anchor, n, i, r), $u(p.ranges[L].head, n, i, r);
            continue;
          }
      ...
      function Ni(e, n, i, r) {
        var a = n, p = n;
        return typeof n == "number" ? p = we(e, Ss(e, n)) : a = j(n), a == null ? null : (r(p, a) && e.cm && rr(e.cm, a, i), p);
      }
      function Oi(e) {
      ...
      Bi.prototype.clear = function() {
        ...
        if (!(r == null || !n)) {
          ...
          var p = Ei(this);
          sn(i, Math.max(0, i.height - p)), e && (on(e, function() {
            Qu(e, i, -p), rr(e, r, "widget");
        ...
        this.height = null;
        var a = Ei(this) - n;
        !a || (nr(this.doc, r) || sn(r, r.height + a), i && on(i, function() {
      ...
      function Vc(e, n, i, r) {
        ...
        return p && a.noHScroll && (p.display.alignWidgets = !0), Ni(e, n, "widget", function(D) {
          ...
          if (a.insertAt == null ? L.push(a) : L.splice(Math.min(L.length, Math.max(0, a.insertAt)), 0, a), a.line = D, p && !nr(e, D)) {
            var N = Yn(D) < e.scrollTop;
            sn(D, D.height + Ei(a)), N && Na(p, a.height), p.curOp.forceUpdate = !0;
          }
          return !0;
        }), p && Tt(p, "lineWidgetAdded", p, a, typeof n == "number" ? n : j(n)), a;
      }
      var Gu = 0, sr = function(e, n) {
        this.lines = [], this.type = n, this.doc = e, this.id = ++Gu;
      };
      sr.prototype.clear = function() {
        if (!this.explicitlyCleared) {
          var e = this.doc.cm, n = e && !e.curOp;
          if (n && wr(e), Je(this, "clear")) {
            var i = this.find();
            i && Tt(this, "clear", i.from, i.to);
          }
          for (var r = null, a = null, p = 0; p < this.lines.length; ++p) {
            var D = this.lines[p], L = Ai(D.markedSpans, this);
            e && !this.collapsed ? rr(e, j(D), "text") : e && (L.to != null && (a = j(D)), L.from != null && (r = j(D))), D.markedSpans = Fd(D.markedSpans, L), L.from == null && this.collapsed && !nr(this.doc, D) && e && sn(D, Qr(e.display));
          }
          ...
          r != null && e && this.collapsed && qt(e, r, a + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && Fu(e.doc)), e && Tt(e, "markerCleared", e, this, r, a), n && Dr(e), this.parent && this.parent.clear();
        }
        ...
        !n || !r || on(r, function() {
          ...
          if (D && (qs(D), r.curOp.selectionChanged = r.curOp.forceUpdate = !0), r.curOp.updateMaxLine = !0, !nr(i.doc, a) && i.height != null) {
            var L = i.height;
            i.height = null;
            var N = Ei(i) - L;
            N && sn(a, a.height + N);
      ...
      function ei(e, n, i, r, a) {
        ...
        if (p.replacedWith && (p.collapsed = !0, p.widgetNode = Y("span", [p.replacedWith], "CodeMirror-widget"), r.handleMouseEvents || p.widgetNode.setAttribute("cm-ignore-events", "true"), r.insertLeft && (p.widgetNode.insertLeft = !0)), p.collapsed) {
          if (Bs(e, n.line, n, i, p) || n.line != i.line && Bs(e, i.line, n, i, p))
            throw new Error("Inserting collapsed marker partially overlapping an existing one");
          Od();
        }
        p.addToHistory && Mu(e, { from: n, to: i, origin: "markText" }, e.sel, NaN);
        var L = n.line, N = e.cm, W;
        if (e.iter(L, i.line + 1, function(k) {
          N && p.collapsed && !N.options.lineWrapping && Tn(k) == N.display.maxLine && (W = !0), p.collapsed && L != n.line && sn(k, 0), Bd(k, new co(
            p,
            L == n.line ? n.ch : null,
            L == i.line ? i.ch : null
          ), e.cm && e.cm.curOp), ++L;
          ...
          return p.clear();
        }), p.readOnly && (Nd(), (e.history.done.length || e.history.undone.length) && e.clearHistory()), p.collapsed && (p.id = ++Gu, p.atomic = !0), N) {
          if (W && (N.curOp.updateMaxLine = !0), p.collapsed)
            ...
            for (var V = n.line; V <= i.line; V++)
              rr(N, V, "text");
          p.atomic && Fu(N.doc), Tt(N, "markerAdded", N, p);
        }
        return p;
      }
      var Hi = function(e, n) {
      ...
      var Kc = 0, _t = function(e, n, i, r, a) {
        ...
        var p = ee(i, 0);
        this.sel = or(p), this.history = new Mo(null), this.id = ++Kc, this.modeOption = n, this.lineSep = r, this.direction = a == "rtl" ? "rtl" : "ltr", this.extend = !1, typeof e == "string" && (e = this.splitLines(e)), ja(this, { from: p, to: p, text: e }), Ut(this, or(p), Nt);
      };
      _t.prototype = hn(Fi.prototype, {
        ...
        setValue: Dt(function(e) {
          ...
          qr(this, {
            ...
            origin: "setValue",
            full: !0
          }, !0), this.cm && Ti(this.cm, 0, 0), Ut(this, or(n), Nt);
        }),
        ...
        replaceSelections: Dt(function(e, n, i) {
          ...
          for (var L = n && n != "end" && Fc(this, r, n), N = r.length - 1; N >= 0; N--)
            qr(this, r[N]);
        ...
        clearHistory: function() {
          var e = this;
          this.history = new Mo(this.history), lr(this, function(n) {
...
`;
            ...
            if (r && r.length && window.FileReader && window.File)
              for (var a = r.length, p = Array(a), D = 0, L = function() {
                ++D == a && wt(n, function() {
                  ...
                  qr(n.doc, J), Nu(n.doc, or(Fe(n.doc, i), Fe(n.doc, ar(J))));
                })();
              }, N = function(J, te) {
              ...
              try {
                ...
                if (V) {
                  var k;
                  if (n.state.draggingText && !n.state.draggingText.copy && (k = n.listSelections()), Io(n.doc, or(i, i)), k)
                    for (var Z = 0; Z < k.length; ++Z)
      ...
      for (var ur = {
        ...
        ur[Ui + 48] = ur[Ui + 96] = String(Ui);
      for (var Oo = 65; Oo <= 90; Oo++)
        ur[Oo] = String.fromCharCode(Oo);
      for (var zi = 1; zi <= 12; zi++)
        ur[zi + 111] = ur[zi + 63235] = "F" + zi;
      var Gn = {};
      Gn.basic = {
        Left: "goCharLeft",
        Right: "goCharRight",
      ...
      function nv(e) {
        ...
        for (var i in e)
          if (e.hasOwnProperty(i)) {
            ...
            for (var a = Ht(i.split(" "), tv), p = 0; p < a.length; p++) {
      ...
      function qu(e) {
        var n = typeof e == "string" ? e : ur[e.keyCode];
      ...
      function rv(e, n, i, r) {
        ...
        var L = function(he, xe) {
          ...
          return e.options.lineWrapping ? (N = N || Vr(e, n), ou(e, n, N, he)) : { begin: 0, end: n.text.length };
        ...
        var te = function(he, xe, ge) {
          for (var Te = function(Ze, Mt) {
            return Mt ? new ee(i.line, L(Ze, 1), "before") : new ee(i.line, Ze, "after");
...
`, "start");
      ...
      function af(e) {
        ...
        if (!(e.target && e.target != n.display.input.getField()) && (n.curOp.focus = q(ve(n)), !Ge(n, e))) {
          ...
          var r = of(n, e);
          g && (Ka = r ? i : null, !r && i == 88 && !uo && (C ? e.metaKey : e.ctrlKey) && n.replaceSelection("", null, "cut")), t && !C && !r && i == 46 && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"), i == 18 && !/\bCodeMirror-crosshair\b/.test(n.display.lineDiv.className) && sv(n);
        }
      }
      function sv(e) {
      ...
      function uf(e) {
        ...
        if (!(Ge(n, e) || i.activeTouch && i.input.supportsTouch())) {
          ...
          if (!Ja(n, e)) {
            var r = Er(n, e), a = Sn(e), p = r ? fv(r, a) : "single";
            ae(n).focus(), a == 1 && n.state.selectingText && n.state.selectingText(e), !(r && dv(n, a, r, p, e)) && (a == 1 ? r ? vv(n, r, p, e) : pi(e) == i.scroller && mt(e) : a == 2 ? (r && Po(n.doc, r), setTimeout(function() {
      ...
      function dv(e, n, i, r, a) {
        var p = "Click";
        return r == "double" ? p = "Double" + p : r == "triple" && (p = "Triple" + p), p = (n == 1 ? "Left" : n == 2 ? "Middle" : "Right") + p, ji(e, _u(p, a), a, function(D) {
      ...
      function vv(e, n, i, r) {
        ...
        e.options.dragDrop && sa && !e.isReadOnly() && i == "single" && (D = p.contains(n)) > -1 && (ye((D = p.ranges[D]).from(), n) < 0 || n.xRel > 0) && (ye(D.to(), n) > 0 || n.xRel < 0) ? pv(e, r, n, a) : hv(e, r, n, a);
      }
      function pv(e, n, i, r) {
      ...
      function hv(e, n, i, r) {
        ...
        if (r.addNew && !r.extend ? (L = p.sel.contains(i), L > -1 ? D = W[L] : D = new Qe(i, i)) : (D = p.sel.primary(), L = p.sel.primIndex), r.unit == "rectangle")
          r.addNew || (D = new Qe(i, i)), i = Er(e, n, !0, !0), L = -1;
        else {
          var V = ff(e, i, r.unit);
        ...
        r.addNew ? L == -1 ? (L = W.length, Ut(
          ...
          { scroll: !1, origin: "*mouse" }
        ), N = p.sel) : Va(p, L, D, ot) : (L = 0, Ut(p, new un([D], 0), ot), N = p.sel);
        var k = i;
        function Z(ge) {
          if (ye(k, ge) != 0)
            if (k = ge, r.unit == "rectangle") {
              for (var Te = [], Re = e.options.tabSize, Me = pe(we(p, i.line).text, i.ch, Re), Be = pe(we(p, ge.line).text, ge.ch, Re), Ze = Math.min(Me, Be), Mt = Math.max(Me, Be), rt = Math.min(i.line, ge.line), an = Math.min(e.lastLine(), Math.max(i.line, ge.line)); rt <= an; rt++) {
                var en = we(p, rt).text, vt = Bt(en, Ze, Re);
                Ze == Mt ? Te.push(new Qe(ee(rt, vt), ee(rt, vt))) : en.length > vt && Te.push(new Qe(ee(rt, vt), ee(rt, Bt(en, Mt, Re))));
              }
              ...
              var tn = D, Ot = ff(e, ge, r.unit), yt = tn.anchor, pt;
              ye(Ot.anchor, yt) > 0 ? (pt = Ot.head, yt = jr(tn.from(), Ot.anchor)) : (pt = Ot.anchor, yt = Zt(tn.to(), Ot.head));
              var st = N.ranges.slice(0);
              st[L] = gv(e, new Qe(Fe(p, yt), pt)), Ut(p, Dn(e, st, L), ot);
            }
        }
      ...
      function cf(e, n) {
        Vn(e.display, n) || mv(e, n) || Ge(e, n, "contextmenu") || z || e.display.input.onContextMenu(n);
      }
      function mv(e, n) {
        return Je(e, "gutterContextMenu") ? df(e, n, "gutterContextMenu", !1) : !1;
      }
      function vf(e) {
      ...
      function tt(e, n) {
        ...
        var a = new tt.inputStyles[n.inputStyle](this), p = this.display = new Nc(e, r, a, n);
        p.wrapper.CodeMirror = this, vf(this), n.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), hu(this), this.state = {
          keyMaps: [],
          overlays: [],
          modeGen: 0,
          overwrite: !1,
        ...
        }, 20), Sv(this), qc(), wr(this), this.curOp.forceUpdate = !0, Tu(this, r), n.autofocus && !E || this.hasFocus() ? setTimeout(function() {
        ...
        for (var L = 0; L < Za.length; ++L)
          Za[L](this);
        Dr(this), T && n.lineWrapping && getComputedStyle(p.lineDiv).textRendering == "optimizelegibility" && (p.lineDiv.style.textRendering = "auto");
      }
      tt.defaults = pf, tt.optionHandlers = Ho;
      function Sv(e) {
        var n = e.display;
        ue(n.scroller, "mousedown", wt(e, uf)), f && m < 11 ? ue(n.scroller, "dblclick", wt(e, function(N) {
          if (!Ge(e, N)) {
            var W = Er(e, N);
          ...
          n.scroller.contains(N.target) || cf(e, N);
        });
        var i, r = { end: 0 };
        function a() {
        ...
        ue(L, "keyup", function(N) {
          return lf.call(e, N);
        }), ue(L, "keydown", wt(e, af)), ue(L, "keypress", wt(e, sf)), ue(L, "focus", function(N) {
          return Ia(e, N);
...
`) && (te = ie = ee(te.line, 0)));
      ...
      function hf(e, n) {
        ...
        if (i)
          return e.preventDefault(), !n.isReadOnly() && !n.options.disableInput && n.hasFocus() && on(n, function() {
      ...
      function Ev(e) {
        ...
        e.prototype = {
          ...
          getTokenTypeAt: function(r) {
            r = Fe(this.doc, r);
            var a = Cs(this, we(this.doc, r.line)), p = 0, D = (a.length - 1) / 2, L = r.ch, N;
            if (L == 0)
              N = a[2];
            else
              for (; ; ) {
          ...
          getStateAfter: function(r, a) {
            var p = this.doc;
            return r = Ss(p, r == null ? p.first + p.size - 1 : r), yi(this, r + 1, a).state;
          },
          ...
          coordsChar: function(r, a) {
            return r = nu(this, r, a || "page"), ba(this, r.left, r.top);
          },
          ...
          addWidget: function(r, a, p, D, L) {
            ...
            a.style.top = W + "px", a.style.left = a.style.right = "", L == "right" ? (V = N.sizer.clientWidth - a.offsetWidth, a.style.right = "0px") : (L == "left" ? V = 0 : L == "middle" && (V = (N.sizer.clientWidth - a.offsetWidth) / 2), a.style.left = V + "px"), p && Ac(this, { left: V, top: W, right: V + a.offsetWidth, bottom: W + a.offsetHeight });
          },
          ...
          findPosV: function(r, a, p, D) {
            ...
            for (var W = Fe(this.doc, r), V = 0; V < a; ++V) {
              var k = wn(this, W, "div");
              if (N == null ? N = k.left : k.left = N, W = Af(this, k, L, p), W.hitSide)
                break;
            }
            return W;
          },
          ...
          setSize: Yt(function(r, a) {
            ...
            r != null && (this.display.wrapper.style.width = D(r)), a != null && (this.display.wrapper.style.height = D(a)), this.options.lineWrapping && _s(this);
      ...
      function el(e, n, i, r, a) {
        ...
        function V(xe) {
          ...
          if (r == "codepoint") {
            ...
            a ? ge = rv(e.cm, L, n, i) : ge = Ga(L, n, i);
          if (ge == null)
            if (!xe && W())
...
` ? "n" : !Z || /\s/.test(ie) ? null : "p";
      ...
      Xe.prototype.init = function(e) {
        ...
        ue(a, "paste", function(L) {
          !p(L) || Ge(r, L) || hf(L, r) || m <= 11 && setTimeout(wt(r, function() {
...
`);
        ...
        if (!(p && !p.bad && D && !D.bad && ye(jr(p, D), r) == 0 && ye(Zt(p, D), a) == 0)) {
          var L = n.display.view, N = r.line >= n.display.viewFrom && xf(n, r) || { node: L[0].measure.map[2], offset: 0 }, W = a.line < n.display.viewTo && xf(n, a);
          if (!W) {
        ...
        if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
          ...
          if (h && w && this.cm.display.gutterSpecs.length && bv(e.anchorNode)) {
          ...
          if (!this.composing) {
            ...
            i && r && on(n, function() {
              Ut(n.doc, or(i, r), Nt), (i.bad || r.bad) && (n.curOp.selectionChanged = !0);
            });
          }
        }
        ...
        if (r.ch == 0 && r.line > e.firstLine() && (r = ee(r.line - 1, we(e.doc, r.line - 1).length)), a.ch == we(e.doc, a.line).text.length && a.line < e.lastLine() && (a = ee(a.line + 1, 0)), r.line < n.viewFrom || a.line > n.viewTo - 1)
          return !1;
        var p, D, L;
        r.line == n.viewFrom || (p = br(e, r.line)) == 0 ? (D = j(n.view[0].line), L = n.view[0].node) : (D = j(n.view[p].line), L = n.view[p - 1].node.nextSibling);
        var N = br(e, a.line), W, V;
        if (N == n.view.length - 1 ? (W = n.viewTo - 1, V = n.lineDiv.lastChild) : (W = j(n.view[N + 1].line) - 1, V = n.view[N + 1].node.previousSibling), !L)
          return !1;
        for (var k = e.doc.splitLines(Cv(e, L, V, D, W)), Z = jn(e.doc, ee(D, 0), ee(W, we(e.doc, W).text.length)); k.length > 1 && Z.length > 1; )
          if (Ue(k) == Ue(Z))
            k.pop(), Z.pop(), W--;
          else if (k[0] == Z[0])
            k.shift(), Z.shift(), D++;
        ...
        var e = this;
        (this.cm.isReadOnly() || !this.pollContent()) && on(this.cm, function() {
          return qt(e.cm);
        });
      ...
      function xf(e, n) {
        ...
        if (!i || i.hidden)
          return null;
        var r = we(e.doc, n.line), a = Ks(i, r, n.line), p = oe(r, e.doc.direction), D = "left";
        if (p) {
          var L = Oe(p, n.ch);
          D = L % 2 ? "right" : "left";
        }
        var N = Zs(a.map, n.ch, D);
        ...
        function V(de, he, xe) {
          for (var ge = -1; ge < (W ? W.length : 0); ge++)
            for (var Te = ge < 0 ? N.map : W[ge], Re = 0; Re < Te.length; Re += 3) {
              var Me = Te[Re + 2];
              if (Me == de || Me == he) {
                var Be = j(ge < 0 ? e.line : e.rest[ge]), Ze = Te[Re] + xe;
                return (xe < 0 || Me != de) && (Ze = Te[Re + (xe ? 1 : 0)]), ee(Be, Ze);
              }
            }
        }
        var k = V(D, L, i);
      ...
      ft.prototype.init = function(e) {
        ...
        e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild), y && (a.style.width = "0px"), ue(a, "input", function() {
          ...
          Ge(r, D) || hf(D, r) || (r.state.pasteIncoming = +new Date(), i.fastPoll());
        });
        function p(D) {
          if (!Ge(r, D)) {
            if (r.somethingSelected())
...
`), le(a));
      ...
      }, ft.prototype.createField = function(e) {
      ...
      }, ft.prototype.screenReaderLabelChanged = function(e) {
        ...
        return r;
      }, ft.prototype.showSelection = function(e) {
      ...
      }, ft.prototype.getField = function() {
        return this.textarea;
      }, ft.prototype.supportsTouch = function() {
        return !1;
      ...
      }, ft.prototype.blur = function() {
        this.textarea.blur();
      }, ft.prototype.resetPosition = function() {
        this.wrapper.style.top = this.wrapper.style.left = 0;
      }, ft.prototype.receivedFocus = function() {
        this.slowPoll();
      }, ft.prototype.slowPoll = function() {
        var e = this;
        this.pollingFast || this.polling.set(this.cm.options.pollInterval, function() {
          e.poll(), e.cm.state.focused && e.slowPoll();
        });
      }, ft.prototype.fastPoll = function() {
        var e = !1, n = this;
        n.pollingFast = !0;
        function i() {
          var r = n.poll();
        ...
        n.polling.set(20, i);
      }, ft.prototype.poll = function() {
        var e = this, n = this.cm, i = this.textarea, r = this.prevInput;
        if (this.contextMenuPending || this.resetting || !n.state.focused || er(i) && !r && !this.composing || n.isReadOnly() || n.options.disableInput || n.state.keySeq)
          return !1;
        var a = i.value;
...
`) > -1 ? i.value = e.prevInput = "" : e.prevInput = a, e.composing && (e.composing.range.clear(), e.composing.range = n.markText(
      ...
      }, ft.prototype.ensurePolled = function() {
        this.pollingFast && this.poll() && (this.pollingFast = !1);
      }, ft.prototype.onKeyPress = function() {
        f && m >= 9 && (this.hasSelection = null), this.fastPoll();
      }, ft.prototype.onContextMenu = function(e) {
        ...
        L && i.doc.sel.contains(p) == -1 && wt(i, Ut)(i.doc, or(p), Nt);
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`;
        ...
        if (f && m >= 9 && Z(), z) {
          ...
          setTimeout(J, 50);
      }, ft.prototype.readOnlyChanged = function(e) {
        e || this.reset(), this.textarea.disabled = e == "nocursor", this.textarea.readOnly = !!e;
      }, ft.prototype.setUneditable = function() {
      }, ft.prototype.needsContentAttribute = !1;
      function wv(e, n) {
      ...
      function Dv(e) {
        e.off = ze, e.on = ue, e.wheelEventPixels = Oc, e.Doc = _t, e.splitLines = gn, e.countColumn = pe, e.findColumn = Bt, e.isWordChar = An, e.Pass = Ft, e.signal = $e, e.Line = $r, e.changeEnd = ar, e.scrollbarModel = pu, e.Pos = ee, e.cmpPos = ye, e.modes = Br, e.mimeModes = bn, e.resolveMode = Hr, e.getMode = Ur, e.modeExtensions = tr, e.extendMode = zr, e.copyState = Ln, e.startState = Wr, e.innerMode = gi, e.commands = Wi, e.keyMap = Gn, e.keyName = ef, e.isModifierKey = qu, e.lookupKey = ti, e.normalizeKeyMap = nv, e.StringStream = lt, e.SharedTextMarker = Hi, e.TextMarker = sr, e.LineWidget = Bi, e.e_preventDefault = mt, e.e_stopPropagation = Zn, e.e_stop = qn, e.addClass = X, e.contains = K, e.rmClass = U, e.keyNames = ur;
      }
      yv(tt), Ev(tt);
      var Mv = "iter insert remove copy getEditor constructor".split(" ");
      for (var Wo in _t.prototype)
        _t.prototype.hasOwnProperty(Wo) && be(Mv, Wo) < 0 && (tt.prototype[Wo] = function(e) {
          return function() {
            return e.apply(this.doc, arguments);
          };
        }(_t.prototype[Wo]));
      return $t(_t), tt.inputStyles = { textarea: ft, contenteditable: Xe }, tt.defineMode = function(e) {
  ...
  (function(l) {
    ...
    l.defineMode("javascript", function(o, t) {
      ...
      function h(j, G) {
        ...
        if (ne == "/")
          return j.eat("*") ? (G.tokenize = C, C(j, G)) : j.eat("/") ? (j.skipToEnd(), y("comment", "comment")) : sn(j, G, 1) ? (x(j), j.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), y("regexp", "string-2")) : (j.eat("="), y("operator", "operator", j.current()));
        if (ne == "`")
      ...
      function pe(j, G) {
        return j == "var" ? P(ae("vardef", G), Zn, se(";"), re) : j == "keyword a" ? P(ae("form"), Ft, pe, re) : j == "keyword b" ? P(ae("form"), pe, re) : j == "keyword d" ? H.stream.match(/^\s*$/, !1) ? P() : P(ae("stat"), ot, se(";"), re) : j == "debugger" ? P(se(";")) : j == "{" ? P(ae("}"), ve, We, re, ce) : j == ";" ? P() : j == "if" ? (H.state.lexical.info == "else" && H.state.cc[H.state.cc.length - 1] == re && H.state.cc.pop()(), P(ae("form"), Ft, pe, re, Fr)) : j == "function" ? P(gn) : j == "for" ? P(ae("form"), ve, so, pe, ce, re) : j == "class" || T && G == "interface" ? (H.marked = "keyword", P(ae("form", j == "class" ? j : G), Br, re)) : j == "variable" ? T && G == "declare" ? (H.marked = "keyword", P(pe)) : T && (G == "module" || G == "enum" || G == "type") && H.stream.match(/^\s*\w/, !1) ? (H.marked = "keyword", G == "enum" ? P(we) : G == "type" ? P(uo, se("operator"), oe, se(";")) : P(ae("form"), Jt, se("{"), ae("}"), We, re, re)) : T && G == "namespace" ? (H.marked = "keyword", P(ae("form"), be, pe, re)) : T && G == "abstract" ? (H.marked = "keyword", P(pe)) : P(ae("stat"), In) : j == "switch" ? P(
          ...
          re,
          ce
        ) : j == "case" ? P(be, se(":")) : j == "default" ? P(se(":")) : j == "catch" ? P(ae("form"), Se, Pe, pe, re, ce) : j == "export" ? P(ae("stat"), Hr, re) : j == "import" ? P(ae("stat"), tr, re) : j == "async" ? P(pe) : G == "@" ? P(be, pe) : $(ae("stat"), be, se(";"), re);
      }
      function Pe(j) {
        if (j == "(")
          return P(En, se(")"));
      ...
      function Nt(j, G, ne) {
        ...
        var ee = ne ? Bt : Et;
        return F.hasOwnProperty(j) ? P(ee) : j == "function" ? P(gn, ee) : j == "class" || T && G == "interface" ? (H.marked = "keyword", P(ae("form"), ua, re)) : j == "keyword c" || j == "async" ? P(ne ? je : be) : j == "(" ? P(ae(")"), ot, se(")"), re, ee) : j == "operator" || j == "spread" ? P(ne ? je : be) : j == "[" ? P(ae("]"), lt, re, ee) : j == "{" ? Xt(jt, "}", null, ee) : j == "quasi" ? $(ut, ee) : j == "new" ? P(yr(ne)) : P();
      }
      function ot(j) {
        return j.match(/[;\}\)\],]/) ? $() : $(be);
      }
      ...
      function ut(j, G) {
        return j != "quasi" ? $() : G.slice(G.length - 2) != "${" ? P(ut) : P(ot, Kt);
      }
      function Kt(j) {
        if (j == "}")
          return H.marked = "string-2", H.state.tokenize = R, P(ut);
      }
      function Ue(j) {
      ...
      function yr(j) {
        return function(G) {
          return G == "." ? P(j ? hn : yn) : G == "variable" && T ? P(Je, j ? Bt : Et) : $(j ? je : be);
        };
      }
      function yn(j, G) {
        if (G == "target")
      ...
      function qn(j, G) {
        return j == "variable" && !H.stream.match(/^\s*:/, !1) ? (Q(G), P(Sn)) : (j == "variable" && (H.marked = "property"), j == "spread" ? P(Jt) : j == "}" ? $() : j == "[" ? P(be, se("]"), se(":"), qn) : P(se(":"), Jt, Sn));
      }
      function pi() {
        return $(Jt, Sn);
      }
      ...
      function hi(j) {
        return j == "var" ? P(Zn, _n) : j == "variable" ? P(_n) : $(_n);
      }
      function _n(j, G) {
        return j == ")" ? P() : j == ";" ? P(_n) : G == "in" || G == "of" ? (H.marked = "keyword", P(be, _n)) : $(be, _n);
      }
      function gn(j, G) {
        if (G == "*")
      ...
      function er(j, G) {
        if (G == "*")
          return H.marked = "keyword", P(er);
        if (j == "variable")
          return Q(G), P(er);
        if (j == "(")
          return P(Se, ae(")"), Ke(En, ")"), re, Oe, ce);
        if (T && G == "<")
          return P(ae(">"), Ke($t, ">"), re, er);
      }
      function uo(j, G) {
      ...
      function Cn(j, G) {
        ...
        if (j == "variable" || H.style == "keyword")
          return H.marked = "property", P(Ar, Cn);
        if (j == "number" || j == "string")
          return P(Ar, Cn);
        if (j == "[")
          return P(be, Ce, se("]"), Ar, Cn);
        if (G == "*")
          return H.marked = "keyword", P(Cn);
        if (T && j == "(")
          return $(er, Cn);
...
const Jh = Pn({
  ...
  methods: {
    load() {
      const c = qi(id(this.modelValue ? cr(this.modelValue) : this.defaultValue));
      this.oldVal = c, this.$nextTick(() => {
        this.editor = Xh(this.$refs.editor, {
          lineNumbers: !0,
          mode: "javascript",
...
}), Zh = { class: "_fc_struct" }, qh = {
  key: 0,
  ref: "editor"
}, _h = { class: "dialog-footer" }, eg = {
  key: 0,
  class: "_fc_err"
};
function tg(c, A, l, o, t, s) {
  const u = ht("ElButton"), d = ht("ElDialog");
  return et(), Gt("div", Zh, [
    _e(u, {
      ...
      default: nt(() => [
        Or(cn(c.title || c.t("struct.title")), 1)
      ]),
      _: 1
    }),
    _e(d, {
      ...
      footer: nt(() => [
        gt("span", _h, [
          c.err ? (et(), Gt("span", eg, cn(c.t("struct.error")) + cn(c.err !== !0 ? c.err : ""), 1)) : vn("", !0),
          _e(u, {
            onClick: A[1] || (A[1] = (f) => c.visible = !1),
            size: "small"
          }, {
            default: nt(() => [
              Or(cn(c.t("struct.cancel")), 1)
            ]),
            _: 1
          }),
          _e(u, {
      ...
      default: nt(() => [
        c.visible ? (et(), Gt("div", qh, null, 512)) : vn("", !0)
      ]),
      _: 1
    }, 8, ["title", "modelValue"])
  ]);
}
const ng = /* @__PURE__ */ gr(Jh, [["render", tg]]);
function rg(c, A) {
  var l = null;
  return function(...o) {
...
const lg = /* @__PURE__ */ gr(ig, [["render", ag]]);
const sg = Pn({
  name: "Validate",
  inject: ["designer"],
  props: {
...
const fg = /* @__PURE__ */ gr(sg, [["render", ug]]), dg = Pn({
  name: "DragBox",
...
}), vg = { class: "_fc-required" };
function pg(c, A, l, o, t, s) {
  const u = ht("ElSwitch"), d = ht("ElInput");
  return et(), Gt("div", vg, [
    _e(u, {
...
const hg = /* @__PURE__ */ gr(cg, [["render", pg]]);
const gg = Pn({
  name: "TableOptions",
  inheritAttrs: !1,
  props: {
...
}), mg = (c) => (Bv("data-v-0d635ce0"), c = c(), Hv(), c), yg = { class: "_fc_table_opt" }, Ag = ["onClick"], xg = /* @__PURE__ */ mg(() => /* @__PURE__ */ gt("i", { class: "fc-icon icon-add" }, null, -1));
function Sg(c, A, l, o, t, s) {
  const u = ht("el-input"), d = ht("el-table-column"), f = ht("el-table"), m = ht("el-button");
  return et(), Gt("div", yg, [
    _e(f, {
      data: c.modelValue,
      border: "",
      ...
      default: nt(() => [
        (et(!0), Gt(_f, null, ed(c.column, (T, S) => (et(), Hn(d, {
          key: T.label + S,
          label: T.label
        }, {
          default: nt((w) => [
    ...
    _e(m, {
      ...
      default: nt(() => [
        xg,
        Or(" " + cn(c.t("tableOptions.add")), 1)
      ]),
      _: 1
    }, 8, ["onClick"])
  ]);
}
const Eg = /* @__PURE__ */ gr(gg, [["render", Sg], ["__scopeId", "data-v-0d635ce0"]]);
/*!
...
`, ""]), l.exports = o;
        ...
        if (!me.notified) {
          ...
          O(function() {
            for (var oe = me.value, De = me.state == Ft, ue = 0; Ee.length > ue; ) {
              var Ie = Ee[ue++], ze = De ? Ie.ok : Ie.fail, $e = Ie.resolve, Ge = Ie.reject, at = Ie.domain, Je, $t, mt;
              try {
                ze ? (De || (me.rejection === Et && xn(Ce, me), me.rejection = ot), ze === !0 ? Je = oe : (at && at.enter(), Je = ze(oe), at && (at.exit(), mt = !0)), Je === Ie.promise ? Ge(le("Promise-chain cycle")) : ($t = yn(Je)) ? $t.call(Je, $e, Ge) : $e(Je)) : Ge(oe);
              } catch (Zn) {
                at && !mt && at.exit(), Ge(Zn);
              }
            }
      ...
      Ht && (_ = function(Ce) {
        ...
        return Ce === _ || Ce === Kt ? new ut(Ce) : re(Ce);
      ...
      var s = t(5), u = t(8), d = t(35), f = t(42), m = t(14), T = t(76), S = t(105), w = t(11), b = t(16), g = t(55), x = t(13), v = t(25), M = t(29), y = t(28), h = t(60), E = t(48), C = t(77), R = t(52), O = t(125), B = t(235), F = t(126), z = t(71), I = t(18), U = t(59), H = t(19), $ = t(53), P = t(74), Y = t(63), Q = t(51), K = t(64), q = t(10), X = t(93), _ = t(12), le = t(36), Se = t(41), ve = t(30).forEach, ce = Y("hidden"), ae = "Symbol", re = "prototype", se = q("toPrimitive"), pe = Se.set, Pe = Se.getterFor(ae), be = Object[re], je = u.Symbol, Ft = d("JSON", "stringify"), Nt = z.f, ot = I.f, Et = B.f, Bt = U.f, ut = P("symbols"), Kt = P("op-symbols"), Ue = P("string-to-symbol-registry"), Ht = P("symbol-to-string-registry"), yr = P("wks"), yn = u.QObject, hn = !yn || !yn[re] || !yn[re].findChild, In = m && w(function() {
        ...
        var Ie = h(De, !0);
        return v(ue), b(ut, Ie) ? (ue.enumerable ? (b(oe, ce) && oe[ce][Ie] && (oe[ce][Ie] = !1), ue = C(ue, { enumerable: E(0, !1) })) : (b(oe, ce) || ot(oe, ce, E(1, {})), oe[ce][Ie] = !0), In(oe, Ie, ue)) : ot(oe, Ie, ue);
      }, bt = function(oe, De) {
        v(oe);
        ...
        return this === be && b(ut, De) && !b(Kt, De) ? !1 : ue || !b(this, De) || !b(ut, De) || b(this, ce) && this[ce][De] ? ue : !0;
      }, We = function(oe, De) {
        var ue = y(oe), Ie = h(De, !0);
        if (!(ue === be && b(ut, Ie) && !b(Kt, Ie))) {
          var ze = Nt(ue, Ie);
          return ze && b(ut, Ie) && !(b(ue, ce) && ue[ce][Ie]) && (ze.enumerable = !0), ze;
        }
      }, Ce = function(oe) {
        var De = Et(y(oe)), ue = [];
        return ve(De, function(Ie) {
          !b(ut, Ie) && !b(Q, Ie) && ue.push(Ie);
        }), ue;
      }, me = function(oe) {
        var De = oe === be, ue = Et(De ? Kt : y(oe)), Ie = [];
        return ve(ue, function(ze) {
          b(ut, ze) && (!De || b(be, ze)) && Ie.push(ut[ze]);
        }), Ie;
      };
      if (T || (je = function() {
      ...
      } }), f || $(be, "propertyIsEnumerable", Xt, { unsafe: !0 }))), s({ global: !0, wrap: !0, forced: !T, sham: !T }, { Symbol: je }), ve(R(yr), function(Ee) {
        _(Ee);
        ...
        s({ target: "JSON", stat: !0, forced: Oe }, {
          stringify: function(oe, De, ue) {
            ...
            if ($e = De, !(!x(De) && oe === void 0 || jt(oe)))
              return g(De) || (De = function(at, Je) {
                if (typeof $e == "function" && (Je = $e.call(this, at, Je)), !jt(Je))
                  return Je;
...
var wg = /* @__PURE__ */ Tg(Md.exports), Dg = "fcEditor", Mg = 1, Rg = Object.assign || function(c) {
  ...
  mounted: function() {
    ...
    this.$nextTick(function() {
      A.editor = new wg("#editor".concat(A.uni)), A.editor.config.zIndex = 2, A.editor.config.force = !1, A.config && Rg(A.editor.config, A.config), A.init && A.init(A.editor), A.editor.create(), A.enable(), A.editor.txt.html(A.modelValue);
    });
  },
  render: function() {
    var A = bg({}, this.$attrs);
    return delete A.id, _e("div", Uv(A, {
      onInput: this.result,
...
Lt.component("DragTool", kh);
Lt.component("DragBox", dg);
Lt.component("Validate", fg);
Lt.component("Struct", ng);
Lt.component("Fetch", lg);
Lt.component("Required", hg);
Lt.component("TableOptions", Eg);
Rd("FcEditor", Pg);
Lt.register("_fc", {
  load(c, A) {
    A._id = St();
